...
class ComparisonView extends View {
    ...
    init() {
        ...
        this.comparisonTimeSeriesController = new ComparisonTimeSeriesController(this, this.container.select('#countries-timeseries'), {country1Values: this.country1TimeSeries, country2Values: this.country2TimeSeries, data: this.data, countries: this.countries, metrics: this.metrics});
